...
tobacco_poi_availability = tobacco_poi[['CityCode']].value_counts().reset_index()
tobacco_poi_availability = tobacco_poi_availability.rename(columns={0:'POINum'})
alcohol_poi_availability = alcohol_poi[['CityCode']].value_counts().reset_index()
alcohol_poi_availability = alcohol_poi_availability.rename(columns={0:'POINum'})
health_poi_availability = health_poi[['CityCode']].value_counts().reset_index()
health_poi_availability = health_poi_availability.rename(columns={0:'POINum'})
physical_exercise_poi_availability = physical_exercise_poi[['CityCode']].value_counts().reset_index()
physical_exercise_poi_availability = physical_exercise_poi_availability.rename(columns={0:'POINum'})

population = pd.read_csv('./output/environmental_determinants/basic_statistics/population/population_city.csv')
tobacco_poi_availability = tobacco_poi_availability.merge(population,left_on='CityCode',right_on='CityCode',how='right')
...
tobacco_poi_availability = tobacco_poi_availability[['CityName','CityCode','POINum','Population','Availability']]
alcohol_poi_availability = alcohol_poi_availability.merge(population,left_on='CityCode',right_on='CityCode',how='right')
...
alcohol_poi_availability = alcohol_poi_availability[['CityName','CityCode','POINum','Population','Availability']]
health_poi_availability = health_poi_availability.merge(population,left_on='CityCode',right_on='CityCode',how='right')
...
health_poi_availability = health_poi_availability[['CityName','CityCode','POINum','Population','Availability']]
physical_exercise_poi_availability = physical_exercise_poi_availability.merge(population,left_on='CityCode',right_on='CityCode',how='right')
...
physical_exercise_poi_availability = physical_exercise_poi_availability[['CityName','CityCode','POINum','Population','Availability']]


tobacco_poi_availability = tobacco_poi_availability.sort_values(['CityCode'], ascending=True)
alcohol_poi_availability = alcohol_poi_availability.sort_values(['CityCode'], ascending=True)
health_poi_availability = health_poi_availability.sort_values(['CityCode'], ascending=True)
physical_exercise_poi_availability = physical_exercise_poi_availability.sort_values(['CityCode'], ascending=True)

tobacco_poi_availability.to_csv(OUTPUT_PATH_AVAIL.joinpath('tobacco_availability_city.csv'),index=False)
alcohol_poi_availability.to_csv(OUTPUT_PATH_AVAIL.joinpath('alcohol_availability_city.csv'),index=False)
health_poi_availability.to_csv(OUTPUT_PATH_AVAIL.joinpath('health_availability_city.csv'),index=False)
physical_exercise_poi_availability.to_csv(OUTPUT_PATH_AVAIL.joinpath('physical_exercise_availability_city.csv'),index=False)
