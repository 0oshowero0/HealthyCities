...
data = data.sort_values(by=['CityCode','MSOACode','Date'], ascending=True)
data = data[['CityName','CityCode','MSOAName','MSOACode','Date','NewCasesBySpecimenDateRollingSum']]

data.to_csv(OUTPUT_PATH.joinpath('COVID_msoa.csv'),index=False)